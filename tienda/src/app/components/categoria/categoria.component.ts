...
export class CategoriaComponent {
  ...
  ngOnInit(): void {
    this.getCategoria();
    this.suscription = this.categoriaService.refresh$.subscribe(() => {
      this.getCategoria();
    })
  }
  getCategoria() {
    this.categoriaService.getCategorias().subscribe(
      (categorias) => {
        this.tarjetasFiltradas = categorias;
  ...
  buscarTarjetas() {
    ...
    return this.tarjetasFiltradas.filter(tarjeta => // Cambiar a tarjetasFiltradas
      tarjeta.NombreCategoria.toLowerCase().includes(this.Busqueda.toLowerCase())
    );
  }
  ...
  Eliminar(id: any) {
    this.categoriaService.EliminarCategoria(id).subscribe(resp => {
  ...
  Actualizar() {
    ...
    if (this.form.valid) {
      ...
      this.categoriaService.ActualizarCategoria(this.ProductoID, data).subscribe(response => {
